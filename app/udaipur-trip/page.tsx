...
export const metadata = {
  title: 'Udaipur × Jawai Safari — Coming Soon | Being Traveller',
  description: 'This expedition is coming soon. The itinerary and departure dates will be announced shortly.',
};

export default function UdaipurTripPage() {
  return (
    <div className="min-h-[85vh] flex flex-col justify-center items-center text-center px-6 md:px-12 py-32 relative overflow-hidden bg-gradient-to-b from-[#0a120b] via-[#070e08] to-obsidian">
      <div className="relative z-10 max-w-2xl mx-auto space-y-6">
        ...
        <p className="font-sans text-sm sm:text-base text-ivory-dark max-w-lg mx-auto font-light leading-relaxed">
          The full day-by-day itinerary and cohort dates for this expedition are being finalized.
